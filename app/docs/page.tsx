...
const copy = {
  en: {
    ...
    nav: [
      ["Start", [["#overview", "Conventions"], ["#quickstart", "5-minute quickstart"], ["#catalog", "Market & catalog"], ["#auth", "Authentication"], ["#examples", "Request examples"]]],
    ...
    billingBody:
      "Balances and prices use integer USD micro-units (1 USD = 1,000,000 micro-USD). Before proxying, RelayBase reserves the verified product price. An upstream HTTP 200 finalizes the charge; a non-200 response, network failure or invalid upstream body refunds the reservation automatically.",
    billingChecks: [
  ...
  zh: {
    ...
    navLabel: "文档目录",
    nav: [
      ["开始", [["#overview", "基本约定"], ["#quickstart", "5 分钟快速开始"], ["#catalog", "数据市场与目录"], ["#auth", "鉴权"], ["#examples", "请求示例"]]],
    ...
    billingTitle: "计费语义",
    billingBody:
      "余额与价格使用美元微单位整数（1 美元 = 1,000,000 微美元）。代理前预留已核验产品价格；上游 HTTP 200 最终扣费，非 200、网络失败或无效响应自动退款。",
    billingChecks: [
...
X-RelayBase-Max-Cost-Usd-Micros: 2000`}
          ...
          <section id="examples">
            <div className="docs-section-label">05 / EXAMPLES</div>
          ...
          <section id="response">
            <div className="docs-section-label">06 / RESPONSE</div>
...
X-RelayBase-Balance-Usd-Micros: 24998000`}
          ...
          <section id="errors">
            <div className="docs-section-label">07 / ERRORS</div>
            <h2>{c.errorsTitle}</h2>
  ...
  "error": {
    ...
    "requestId": "req_01K2..."
          ...
          <section id="retries">
            <div className="docs-section-label">08 / RETRIES</div>
...
honor Retry-After when present`}
          ...
          <section id="billing">
            <div className="docs-section-label">09 / BILLING</div>
...
Header: X-RelayBase-Max-Cost-Usd-Micros: 2000`}
          ...
          <section id="webhooks">
            <div className="docs-section-label">10 / PAYMENT</div>
          ...
          <section id="production">
            <div className="docs-section-label">11 / PRODUCTION</div>
